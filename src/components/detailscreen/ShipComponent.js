    ...
    return (
        <View style={ styles.container }>
            ...
            <View style={ styles.topContainer }>
                ...
                <View style={ styles.textContainer }>
                    <Text style={ styles.text } numberOfLines={1}>Phí vận chuyển: { (8000).toLocaleString('vi', {style : 'currency', currency : 'VND'}) }</Text>
                </View>
            </View>
            ...
            <View style={[ styles.topContainer, { backgroundColor: '#fffaea' } ]}>
                ...
                <View style={ styles.textContainer }>
                    <Text style={{ color: '#26ab97' }} numberOfLines={1}>Grabee Đảm Bảo</Text>
